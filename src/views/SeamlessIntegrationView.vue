<template>
  <teleport to="head">
    <component :is="'script'" src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.1/jquery.min.js" async />
    <component :is="'script'"
      src="https://sandbox.merchant.razer.com/RMS/API/seamless/latest/js/MOLPay_seamless.deco.js" async />
  </teleport>
